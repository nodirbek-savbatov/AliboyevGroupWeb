      ...
      <div className="max-w-screen-xl mx-auto flex flex-wrap items-center justify-between p-4">
        ...
        <div className="flex items-center space-x-5 md:order-2">
          ...
          <div className="relative">
            <FaUser 
              className="w-5 h-5 text-gray-700 cursor-pointer hover:text-blue-600 transition"
              onClick={toggleDropdown}
            />
            {isDropdownOpen && (
              <div className="absolute right-0 mt-2 w-40 bg-white shadow-lg rounded-lg p-2 border border-gray-200">
                {token ? (
                  <>
